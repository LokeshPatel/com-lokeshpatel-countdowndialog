//  com-lokeshpatel-countdowndialog
//  Repo: https://github.com/LokeshPatel/com-lokeshpatel-countdowndialog
package com.lokeshpatel.countdowndialog;
			...
			Runnable runnable = new Runnable() {
				public void run() {
					...
					Typeface face = Typeface.createFromAsset(cordova.getActivity().getAssets(),
							"www/plugins/com-lokeshpatel-countdowndialog/www/digital-7.ttf");
